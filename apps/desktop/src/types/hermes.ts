...
export interface OAuthProvider {
   ...
   *  embedded terminal. Null when Nox doesn't know how to remove it. */
...
export interface SkillInfo {
  ...
  usage?: number
  /** 'agent' = learned/local (editable), 'bundled' = ships with Nox, 'hub' = installed. */
 ...
 *  not Nox); elsewhere, driver health from `cua-driver doctor`. `null`
