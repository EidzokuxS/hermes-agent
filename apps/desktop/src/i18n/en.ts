...
export const en: Translations = {
  ...
  boot: {
    ready: 'Nox Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Nox settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Nox Desktop…'
    },
    errors: {
      backgroundExited: 'Nox background process exited.',
      backgroundExitedDuringStartup: 'Nox background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Nox backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update Nox',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Nox Desktop.',
    ...
    native: {
      ...
      inputBody: 'Nox is waiting for your response.',
      turnDoneTitle: 'Nox finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Nox defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Nox is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Nox asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Nox was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Nox follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Nox is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Nox, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Nox checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Nox configuration...',
    ...
    gateway: {
      ...
      intro:
        'Nox Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Nox backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private Nox backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Nox backend.',
      remoteAuthHint:
      ...
      restartingMessage: 'Nox Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Nox ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Nox runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  starmap: {
    ...
    emptyDesc: 'As Nox builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Nox to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Nox to generate pets.',
      backgroundHint: 'You can close this — Nox will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Nox desktop' },
    ...
    hermesActiveSessions: (version, count) => `Nox ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Nox environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Nox will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Nox backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Nox. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    introDescription: 'Start a conversation or reopen a session. Files, tools, and connected models stay available here.',
    message: 'Message',
    wakingProfile: profile => `Waking up ${profile}…`,
    placeholderStarting: 'Starting Nox...',
    placeholderReconnecting: 'Reconnecting to Nox…',
    ...
    attachUrlDesc: 'Nox will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of Nox can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Nox is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Nox backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Nox from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Nox will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Nox desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Nox updater takes over in its own window and reopens Nox automatically when it’s done. Please don’t reopen Nox yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Nox reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Nox reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Nox needs a one-time install',
    ...
    settingUpTitle: 'Setting up Nox',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Nox CLI or desktop instance is running. Stop any running Nox instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Nox installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: 'Choose a model provider',
    headerDesc: 'Connect one now, or choose one later in Settings.',
    providerCheckUnavailable: 'Provider status could not be checked. You can still choose an option below.',
    preparingInstall: 'Nox is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Nox…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Nox',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Nox at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Nox connects automatically',
    ...
    authorizeThere: 'Authorize Nox there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Nox there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Nox Desktop v${version}`,
      ...
      gatewayTitle: 'Nox inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Nox will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Nox is restarting...',
      askRestart: 'Ask Nox to restart the server',
      lookingRestart: taskId => `Nox is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Nox is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Nox finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Nox could not restart the server.',
      stillWorking:
        'Nox is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Nox is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Nox gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent Nox allowlist. Nox won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Nox needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Nox needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Nox Desktop to use Save Image.',
    restartToSaveImages: 'Restart Nox Desktop to save images',
