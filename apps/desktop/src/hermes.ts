...
// "Timed out connecting to Nox backend" that hangs the UI (#48504).
//
...
export class HermesGateway extends JsonRpcGatewayClient {
  constructor() {
    super({
      closedErrorMessage: 'Nox gateway connection closed',
      connectErrorMessage: 'Could not connect to Nox gateway',
      createRequestId: nextId => nextId,
      notConnectedErrorMessage: 'Nox gateway is not connected',
