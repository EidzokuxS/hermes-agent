...
const OPTIONS: ModeOption[] = [
  {
    ...
    description: 'Remove the Nox desktop app. The local runtime, your config, and chats all stay.',
  ...
  },
  {
    ...
    description: 'Remove the app and its local runtime, but keep config, chats, and secrets for a future reinstall.',
    consequence: 'the Nox desktop app and local runtime (config, chats, and secrets are kept)',
    needsAgent: true
  },
  {
    mode: 'full',
    ...
    consequence: 'EVERYTHING — Nox, its local runtime, and all of your config, chats, secrets, and logs',
      ...
      <div className="rounded-xl border border-destructive/30 bg-destructive/5 px-4 py-3">
        {loading ? (
          ...
          <div className="flex flex-col gap-2">
            <p className="text-sm font-medium">Uninstall Nox</p>
