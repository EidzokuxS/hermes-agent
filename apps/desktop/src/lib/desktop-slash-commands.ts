...
/** Why a known Nox command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active Nox profile', surface: action('profile') },
  ...
  { name: '/version', description: 'Show Nox Agent version', surface: exec() },
 ...
 * Nox' built-in slash commands — i.e. skill commands (`/gif-search`,
