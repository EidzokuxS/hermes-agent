 ...
 *
 * A Nox foundation install can end up with `origin=git@github.com:EidzokuxS/hermes-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/EidzokuxS/hermes-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/eidzokuxs/hermes-agent'
