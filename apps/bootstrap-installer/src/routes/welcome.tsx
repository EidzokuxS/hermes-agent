 ...
 *   - NOX wordmark rendered in Collapse Bold, uppercase, tracked
    ...
    <div className="hermes-fade-in flex h-full flex-col items-center justify-center gap-10 px-12 py-10">
      ...
      <div className="w-full max-w-2xl min-w-0 text-center">
        ...
        >
          ...
          <span aria-hidden="true">NOX</span>
        </p>

        <p className="m-0 text-center text-base leading-normal tracking-tight text-muted-foreground">
          We&rsquo;ll set up Nox in the background. This may take a few minutes.
        </p>
      </div>
