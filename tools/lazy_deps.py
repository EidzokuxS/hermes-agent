...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    "tool.dashboard": (
        ...
        "starlette==1.3.1",  # Keep advisory-fixed lazy install in sync with pyproject [web]
    ...
    "tool.computer_use": (
        "mcp==1.26.0",
        "starlette==1.3.1",  # Keep advisory-fixed lazy install in sync with pyproject [computer-use]
    ),
